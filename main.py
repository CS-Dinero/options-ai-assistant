...
def build_derived(market: dict) -> dict:
    """
    Compute all derived analytics from the raw market context dict.
    Safe to call with partial market data — missing fields produce
    "unknown" regime states which the scorer handles via reweighting.
    """
